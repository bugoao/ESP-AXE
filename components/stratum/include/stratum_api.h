...
#define STRATUM_CLIENT_NAME "NiceHash"
...
typedef struct
{
    ...
    bool pool_target_set;
    uint8_t extranonce_prefix[32];
    uint8_t extranonce_prefix_len;
    bool extranonce_prefix_set;
    bool pool_target_tracks_channel;
    bool version_mask_tracks_connection;
    bool invalidate_active_work;
    bool version_rolling_allowed_set;
...
int STRATUM_V1_submit_share(int socket, int send_uid, const char *username, const char *jobid,
                            ...
                            uint32_t version, bool version_rolling_negotiated);
