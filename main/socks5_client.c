...
static int connect_direct_ipv4(uint32_t target_ipv4_addr, uint16_t target_port)
{
                                ...
                                const struct timeval *io_timeout)
{
    ...
    if (connect(sock, (struct sockaddr *)&proxy_sockaddr, sizeof(proxy_sockaddr)) != 0) {
                                    ...
                                    bool *proxy_failed)
{
    ...
    return connect_direct_ipv4(target_ipv4_addr, target_port);
}
